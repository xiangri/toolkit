...
os.environ["TESSDATA_PREFIX"] = '/Users/xiangri/github/toolkit/tessdata'
...
def t(file_path):
    ...
    # binary = cv2.adaptiveThreshold(~gray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 35, -5)
    # cv2.imshow("binary_picture", binary)  # 展示图片
    # s = pytesseract.image_to_string(gray, lang="chi_sim")
    s = pytesseract.image_to_data(gray, lang="chi_sim")
    print(s)


if __name__ == '__main__':
    file = "/Users/xiangri/github/toolkit/img.png"
    # 解析数据
